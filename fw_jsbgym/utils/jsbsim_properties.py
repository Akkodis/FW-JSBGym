...
u_kph = BoundedHelperProperty('velocities/u-kph', 'body frame x-axis velocity [km/h]', -1000, 1000)
v_kph = BoundedHelperProperty('velocities/v-kph', 'body frame y-axis velocity [km/h]', -1000, 1000)
w_kph = BoundedHelperProperty('velocities/w-kph', 'body frame z-axis velocity [km/h]', -1000, 1000)
...
reward_actvar = BoundedProperty("reward/actvar", "action variation reward", 0, float('+inf'))
