...
gymnasium.register(
    ...
    entry_point='fw_jsbgym.envs.tasks.waypoint_tracking.wp_tracking:WaypointTrackingENU'
)
...
gymnasium.register(
    id='CourseAltVaTracking-v0',
    entry_point='fw_jsbgym.envs.tasks.waypoint_tracking.wp_tracking:CourseAltVaTracking'
)


gymnasium.register(
    id='CourseAltNoVaTracking-v0',
    entry_point='fw_jsbgym.envs.tasks.waypoint_tracking.wp_tracking:CourseAltNoVaTracking'
)
...
gymnasium.register(
    id='DubinsPathTrackingIndep-v0',
    entry_point='fw_jsbgym.envs.tasks.waypoint_tracking.dubins_path_tracking:DubinsPathTrackingIndep'
)